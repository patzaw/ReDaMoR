# Create a [RelDataModel](https://patzaw.github.io/ReDaMoR/reference/RelDataModel.md) object from column names of data frames

Create a
[RelDataModel](https://patzaw.github.io/ReDaMoR/reference/RelDataModel.md)
object from column names of data frames
...
- ...:
  ...
  the data frame objects, as names (unquoted) or character strings
  (quoted)
...
- pos:
  ...
  where to get the objects. By default, uses the current environment.
...
The pos argument can specify the environment from which to get the
objects in any of several ways: as an integer (the position in the
search list); as the character string name of an element in the search
list; or as an environment. The envir argument is an alternative way to
