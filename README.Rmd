...
The ReDaMoR package allows the manipulation of relational data models in R. It
...
The [TKCat](https://github.com/patzaw/TKCat) package relies on ReDaMoR to
...
[dm](https://github.com/krlmlr/dm) R package to interact more easily with
relational data.
