...
The ReDaMoR package allows the manipulation of relational data models in R.
...
A public instance of the Shiny app is available [here](https://pgodard.shinyapps.io/ReDaMoR).
...
Documentation is available in [this vignette](https://patzaw.github.io/ReDaMoR).

<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
# Future work

We are working on `internalMDB` objects which bind the data to their relational model.
These objects will allow the manipulation and the combination of datasets in a consistent manner.
We hope to release the corresponding package soon.
...
This work was entirely supported by [UCB Pharma](https://www.ucb.com/) (Early Solutions department).
